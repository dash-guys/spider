...
public class HttpRequestConfig {
     ...
     * @return	返回当前对象
     */
    public static HttpRequestConfig custom(){
...
//	private Map<String, Object> map;
     ...
     * @return	返回当前对象
     */
    public HttpRequestConfig headers(Header[] headers) {
     ...
     * @return	返回当前对象
     */
    public HttpRequestConfig headers(Header[] headers, boolean isReturnRespHeaders) {
        this.headers = headers;
     ...
     * @return	返回当前对象
     */
    public HttpRequestConfig method(HttpMethods method) {
        this.method = method;
        return this;
    }
     ...
     * @return	返回当前对象
     */
    public HttpRequestConfig methodName(String methodName) {
     ...
     * @return	返回当前对象
     */
    public HttpRequestConfig  map(Map<String, Object> map) {
     ...
     * @return	返回当前对象
     */
    public HttpRequestConfig files(String[] filePaths) {
     ...
     * @return	返回当前对象
     */
    public HttpRequestConfig files(String[] filePaths, String inputName) {
     ...
     * @return	返回当前对象
     */
    public HttpRequestConfig files(String[] filePaths, String inputName, boolean forceRemoveContentTypeChraset) {
        Map<String, Object> m = maps.get();
        if(m==null || m==null){
     ...
     * @return	返回当前对象
     */
    public HttpRequestConfig encoding(String encoding) {
        //设置输入输出
        inenc(encoding);
        outenc(encoding);
     ...
     * @return	返回当前对象
     */
    public HttpRequestConfig inenc(String inenc) {
        this.inenc = inenc;
        return this;
    }
     ...
     * @return	返回当前对象
     */
    public HttpRequestConfig outenc(String outenc) {
        this.outenc = outenc;
        return this;
    }
     ...
     * @return	返回当前对象
     */
    public HttpRequestConfig timeout(int timeout){
     ...
     * @return	返回当前对象
     */
    public HttpRequestConfig timeout(int timeout, boolean redirectEnable){
        // 配置请求的超时设置
    ...
    public HttpRequestConfig requestConfig(RequestConfig requestConfig) {
     ...
     * @return	返回当前对象
     */
    public HttpRequestConfig timeout(RequestConfig requestConfig){
        this.requestConfig = requestConfig;
        return this;
    }
